...
public class Program
{
    ...
    public void Task_2_3(ref int[,] B, ref int[,] C)
    {
        ...
        static int FindDiagonalMax(int[,] matrix)
        {
        ...
        static int[,] Del(int[,] matrix, int a)
        {
        ...
        B = Del(B, FindDiagonalMax(B));
        C = Del(C, FindDiagonalMax(C));
        // end
    }
    ...
    public void Task_2_5(int[,] A, int[,] B)
    {
        ...
        static int FindMaxInColumn(int[,] C)
        {
            int maxel = int.MinValue;
            int ind_i = 0;
    ...
    public void Task_2_7(ref int[,] B, int[,] C)
    {
        ...
        int[,] A = new int[5, 5];
        static int CountRowPositive(int[,] C)
        {
            int maxel = int.MinValue;
            int count = 0;
            int ind_i = 0;
        ...
        static int CountColumnPositive(int[,] C)
        {
            int maxel = int.MinValue;
            int count = 0;
            int ind_j = 0;
    ...
    public void Task_2_11(int[,] A, int[,] B)
    {
        ...
        (ai, aj) = FindMaxIndex(A);
        (bi, bj) = FindMaxIndex(B);
        int c = A[ai, aj];
        A[ai, aj] = B[bi, bj];
        B[bi, bj] = c;
        // end
    ...
    public int Task_2_15(int[,] A, int[,] B, int[,] C)
    {
        ...
        static int suGetAverageWithoutMinMaxmma(int[,] matrix)
        {
            int ai, aj, bi, bj;
            (ai, aj) = FindMaxElem(matrix);
            (bi, bj) = FindMinElem(matrix);
            matrix[ai, aj] = 0;
            matrix[bi, bj] = 0;
        ...
        if ((suGetAverageWithoutMinMaxmma(A) < suGetAverageWithoutMinMaxmma(B)) && (suGetAverageWithoutMinMaxmma(B) < suGetAverageWithoutMinMaxmma(C)))
        {
            answer = 1;
        }
        else if ((suGetAverageWithoutMinMaxmma(A) >= suGetAverageWithoutMinMaxmma(B)) && (suGetAverageWithoutMinMaxmma(B) >= suGetAverageWithoutMinMaxmma(C)))
            answer = -1;
        else
        {
            answer = 0;
    ...
    public void Task_2_21(int[,] A, int[,] B, out int[] answerA, out int[] answerB)
    {
        ...
        answerA = [5];
        answerB = [6];
        static int FindMinElem(int[,] A, int ind)
        {
            int max = A[0, 0];
            int ind_i = ind;
            for (int i = ind; i < A.GetLength(0); i++)
            {
    ...
    public void Task_2_23(double[,] A, double[,] B)
    {
        ...
        static void MatrixValuesChange(ref double[,] matrix, double[] arrmx)
        {
            for (int i = 0; i < matrix.GetLength(0); i++)
            {
                for (int j = 0; j < matrix.GetLength(1); j++)
    ...
    public void Task_2_27(int[,] A, int[,] B)
    {
        ...
        static int FindMaxElem(int[,] matrix, int rowIndex)
        {
    ...
    public void Task_3_5(out int func1, out int func2)
    {
        ...
        static int CountSignFlips1(double a, double b, double h)
        {
            int k = 1;
        ...
        static int CountSignFlips2(double a, double b, double h)
        {
            int k = 1;
    ...
    public void Task_3_13(ref int[,] matrix)
    {
        ...
        int[,] A = new int[3, 5];
        int[,] B = new int[4, 5];
        static int FindMaxElem(int[,] matrix)
        {
        ...
        static int FindMinElem(int[,] matrix)
        {
        ...
        static int[,] Remove(int[,] matrix, int a)
        {
            int[,] matrix2 = new int[matrix.GetLength(0) - 1, matrix.GetLength(1)];
            for (int i = 0; i < a; i++)
            {
    ...
    public void Task_3_27(int[,] A, int[,] B)
    {
        ...
        static int Ind_J(int[,] matrix, int ind)
        {
        ...
        static int[,] Replace(int[,] matrix)
        {
            ...
            else
            {
                ...
                int x = find(matrix, matrix.GetLength(0) - 1);
                matrix[matrix.GetLength(0) - 1, x] *= (x + 1);
            }
            return matrix;
        }
        A = Replace(A);
